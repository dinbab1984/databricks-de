...
# MAGIC %sql
# MAGIC -- TODO
# MAGIC SELECT user_id, to_date(start_time) as date , min(start_time), max(end_time), collect_list(workout_id) as workouts
# MAGIC FROM completed_workouts GROUP BY user_id, to_date(start_time)
# MAGIC LIMIT 10
