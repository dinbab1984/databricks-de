...
# DBTITLE 0,--i18n-65df298d-79ae-4ce6-9e3a-b736cde03178
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC # Functions
...
# DBTITLE 0,--i18n-568cdf5f-5b84-4bf8-8709-4b58765d2640
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ## Functions
...
# DBTITLE 0,--i18n-d8d44355-44a5-40a3-b8aa-30931e08d346
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-1a38c434-5f42-44fc-9338-b3d92a94548e
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-7511c94b-96a6-462c-89d6-af36b14548d7
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ### Parameters
...
# DBTITLE 0,--i18n-4c927ca4-1ba3-4ee8-a691-9c4a421c99ee
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ### Arguments
...
# DBTITLE 0,--i18n-fddb317f-15f3-44ea-bd84-2a05d88b80f4
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-19d2ba46-1dd6-48f6-b538-103e590886c4
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-36e4e6b0-7826-11ee-b962-0242ac120002
# MAGIC %md
# MAGIC
# MAGIC #### Mixed Invocation
# MAGIC
# MAGIC We can also invoke functions using positional and named arguments, however the **positional arguments must always be specified first**. Intuitively, this rule makes sense, since positioning becomes irrelevant once we're naming arguments.
# MAGIC
# MAGIC Here is an example of this hybrid usage. By virtue of its position, **`dollar_amount`** is assigned the value **`10.0`** (since it appears first in the function declaration), and **`conversion_rate`** is specified by name.
# MAGIC
# MAGIC Note that the second invocation would fail, because we'd be attempting to assign **`dollar_amount`** twice: once implicitly through a positional argument, and again by name.
...
# DBTITLE 0,--i18n-6bdc03a2-ebb6-4b4d-b5dd-032a434d9694
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-58cec573-c5dd-48cb-8276-a92362f460f5
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-95f77560-18ee-44d0-8b8d-1f3648916c31
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-02f39e81-a952-4b78-a668-258e8e4b406f
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-97416e6a-ea97-453c-b6a9-79d314c037d6
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-aa8d0e9c-37c2-4664-a34d-f10b8d125887
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ### Type Hints
...
# DBTITLE 0,--i18n-39b419fb-8600-4ae3-8b0e-f8019137fde8
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-5c6b9dd2-f667-4272-a2c9-6ecce31df1de
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ### Docstrings
...
# DBTITLE 0,--i18n-cd94ab20-f634-4dbf-812e-f885691db238
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-d5f90617-6c63-4a02-b1c4-af90e815e4a0
# MAGIC %md
# MAGIC
# MAGIC
# MAGIC ### Scope
...
# DBTITLE 0,--i18n-00c7e6a3-c466-4242-8d25-c60efacc9175
# MAGIC %md
# MAGIC
# MAGIC
...
# DBTITLE 0,--i18n-8dca298f-3225-4e6e-b8ad-e84c72c53f46
# MAGIC %md
# MAGIC
# MAGIC
